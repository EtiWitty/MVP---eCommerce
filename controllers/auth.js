...
exports.signin = (req, res) => {
  ...
  User.findOne({email}, (err, user) => {
    ...
    // if user is found make sure the email and password match - Authenticate the user
    ...
    // generate a signed token with user if and sercret
...
exports.signout = (req, res) => {
  // here we need to clear cookie that we had in signin method
  res.clearCookie('t');
  res.json({
